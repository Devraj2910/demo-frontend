  ...
  return (
    <>
      <div
        ...
        className={`${bgColor} kudo-card rounded-lg overflow-hidden mx-auto w-full h-[400px] flex flex-col max-w-xs relative animate-float`}
        style={{
          boxShadow:
      ...
      >
        ...
        <div
          className='absolute top-1 right-2 text-7xl opacity-40 transform -rotate-12 z-10 animate-pulse-slow'
          style={{
            fontSize: '5rem',
        ...
        <div className='absolute inset-0 bg-black bg-opacity-0 hover:bg-opacity-5 transition-colors flex items-center justify-center opacity-0 hover:opacity-100'>
          <span className='bg-white bg-opacity-80 rounded-full px-3 py-1 text-sm font-medium text-gray-700 shadow-lg'>
      ...
      <KudoDetailModal kudo={kudo} isOpen={isModalOpen} onClose={closeModal} />
    </>
  );
}
